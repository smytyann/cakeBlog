<!-- File: /app/View/Posts/index.ctp -->
         ...
         <div class="row">
             ...
             <div class="col-md-7"> 
        <h2>Blog posts</h2>
       <p><a class="btn btn-lg btn-success"  role="button"<?php echo $this->Html->link('NEW POST',array('controller' => 'posts', 'action' => 'add')); ?></a></p>
        <table>
            <tr>
                <th>Post Id</th>
                <th>Title</th>
        ...
        <!-- Here's where we loop through our $posts array, printing out post info -->
            ...
            <?php endforeach; ?>
              ...
              <div class="col-md-3 imgUser "> 
                   <div id="imgUser" >   <?php echo $this->Html->link($this->Html->image('jornal.jpg'), '/', array('escape' => false));?>
